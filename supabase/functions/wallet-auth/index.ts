...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    console.log(`[WALLET_AUTH] Processing auth for wallet: ${walletAddress.slice(0, 8)}...`);
    ...
    console.log(`[WALLET_AUTH] Successfully authenticated wallet user: ${userId.slice(0, 8)}...`);
